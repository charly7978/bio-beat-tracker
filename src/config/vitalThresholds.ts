...
export const VITAL_THRESHOLDS = {
  ...
  FINGER: {
    ...
    MIN_RED_INTENSITY: 38,
    MIN_RED_DOMINANCE: 10,
    MIN_RG_RATIO: 1.22,
    ENSEMBLE_FINGER_THRESHOLD: 0.52,
    MIN_COVERAGE: 0.09,
    /** R/B mínimo — tejido subcutáneo absorbe azul bajo flash torch */
    HEMOGLOBIN_MIN_RB: 1.75,
    SOFT_COVERAGE_MULT: 0.85,
    /** Adquisición estricta */
    ACQUIRE_RB_STRICT: 2.00,
    ...
    ACQUIRE_SOFT_MIN_RED: 30,
    ACQUIRE_SOFT_RG: 1.15,
    ACQUIRE_SOFT_RB: 1.50,
    ACQUIRE_SOFT_DOMINANCE: 10,
    ...
    /** Pulsación ROI (CV de rawRed) — tercera vía de adquisición (vía universal) */
    ROI_PULSE_BUFFER: 24,
