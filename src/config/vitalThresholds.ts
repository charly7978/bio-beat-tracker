...
export const VITAL_THRESHOLDS = {
  ...
  FINGER: {
    ...
    MAINTAIN_RG: 1.02,
    MAINTAIN_RB: 1.08,
    MAINTAIN_DOMINANCE: 4.5,
    MAINTAIN_COVERAGE: 0.055,
    /** Mantener por PI cuando la firma RGB falla un frame */
    PULSE_HOLD_MIN_PI: 0.00022,
    PULSE_HOLD_MIN_RED: 26,
    PULSE_HOLD_RG: 1.02,
    PULSE_HOLD_RB: 1.03,
    PULSE_HOLD_COVERAGE: 0.065,
