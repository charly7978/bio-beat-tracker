...
export const VITAL_THRESHOLDS = {
  ...
  FINGER: {
    ...
    MIN_RED_INTENSITY: 32,
    MIN_RED_DOMINANCE: 5,
    MIN_RG_RATIO: 0.98,
    ENSEMBLE_FINGER_THRESHOLD: 0.45,
    MIN_COVERAGE: 0.065,
    /** R/B mínimo — dedo absorbe azul; flash sin dedo suele fallar esto */
    HEMOGLOBIN_MIN_RB: 1.12,
    ...
    ACQUIRE_SOFT_MIN_RED: 26,
    ACQUIRE_SOFT_RG: 1.02,
    ACQUIRE_SOFT_RB: 1.12,
    ACQUIRE_SOFT_DOMINANCE: 6,
    ACQUIRE_SOFT_INTENSITY_MIN: 46,
    ACQUIRE_SOFT_INTENSITY_MAX: 850,
    ACQUIRE_SOFT_FINGER_SCORE_ROI: 0.14,
    ACQUIRE_SOFT_SMOOTHED_FINGER: 0.12,
    ACQUIRE_MAX_MOTION_SOFT: 1.00,
    /** Mantener contacto */
    MAINTAIN_MIN_RED: 24,
    MAINTAIN_RG: 1.01,
    MAINTAIN_RB: 1.06,
    MAINTAIN_DOMINANCE: 4.0,
    MAINTAIN_COVERAGE: 0.045,
    /** Mantener por PI cuando la firma RGB falla un frame */
    PULSE_HOLD_MIN_PI: 0.00020,
    PULSE_HOLD_MIN_RED: 24,
    PULSE_HOLD_RG: 1.01,
    PULSE_HOLD_RB: 1.02,
    PULSE_HOLD_COVERAGE: 0.055,
    PULSE_HOLD_MAX_MOTION: 1.00,
    ...
    ROI_RED_CV_MIN: 0.028,
    PULSATILE_ACQUIRE_MIN_RED: 22,
    PULSATILE_ACQUIRE_RG: 1.00,
    PULSATILE_ACQUIRE_RB: 1.03,
    PULSATILE_ACQUIRE_COVERAGE: 0.05,
    PULSATILE_ACQUIRE_FINGER_ROI: 0.12,
    PULSATILE_ACQUIRE_MAX_MOTION: 1.10,
    PULSATILE_ACQUIRE_MIN_DOMINANCE: 3.0,
    /** Clasificación por tile (ROI 5×5) — umbrales relajados para tolerar dedo parcial/ladeado */
    TILE_MIN_RED: 22,
    TILE_MIN_TOTAL: 38,
    TILE_MIN_DOMINANCE: 2.5,
    TILE_MIN_RG: 1.03,
    TILE_MIN_COMBINED_SCORE: 0.18,
    ...
    INSTANT_LOST_TO_NO_CONTACT: 8,
    FINGER_LOST_FRAMES_UI: 6,
    UNSTABLE_GRACE_FRAMES: 2,
