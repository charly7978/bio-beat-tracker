...
El archivo originalmente llamado `PhysiologicalReasoningCore` era una fusión heurística probabilística. No constituía razonamiento fisiológico ni un agente. Ese PR fue cerrado y no debe recuperarse bajo un nombre engañoso. Las ideas útiles solo pueden reutilizarse como evidencia heurística explícitamente clasificada.
